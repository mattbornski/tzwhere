...
var saveCache = function () {
	...
	fs.writeFile(constructedShortcutFilePath, _cache, function (err) {
		...
		if (err) {
			return console.error('Cannot save cache', err);
		}
